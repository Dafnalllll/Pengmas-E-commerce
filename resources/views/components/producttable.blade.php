...
<div class="bg-gray-100 p-4 lg:p-6 rounded-lg shadow-lg relative top-10">
    ...
    <div class="lg:hidden space-y-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md border">
            <div class="flex justify-between items-start mb-3">
                <h3 class="font-semibold text-black text-lg">{{ $product['name'] }}</h3>
            ...
            <div class="space-y-2 mb-4">
                <div class="flex justify-between">
                    ...
                    <span class="font-medium text-black">{{ $product['price'] }}</span>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex-1 ml-2 text-right">
                        @if($product['hasLink'])
                            <a href="{{ $product['link'] }}" class="text-blue-600 hover:underline text-xs break-all">
            ...
            <div class="flex space-x-2">
                <button class="flex-1 bg-gray-300 hover:bg-gray-400 text-black py-2 px-3 rounded-lg font-medium transition-all duration-300 text-sm">
                    Edit
                </button>
                <button class="flex-1 bg-red-800 hover:bg-red-600 text-white py-2 px-3 rounded-lg font-medium transition-all duration-300 text-sm">
                    Delete
                </button>
            </div>
        </div>
    ...
    <div class="flex justify-end mt-6">
        <a href="{{ route('admin.add.product') }}" class="bg-black hover:bg-gray-400 hover:scale-105 text-white px-4 lg:px-6 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center text-sm lg:text-base">
