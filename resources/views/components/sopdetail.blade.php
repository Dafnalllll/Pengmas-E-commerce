...
<body class="min-h-screen flex flex-col relative overflow-x-hidden">
    ...
    <main class="flex-1 relative z-20 pt-20">
        <section class="max-w-3xl mx-auto bg-white/90 rounded-xl shadow-lg p-8 mt-16 mb-16" data-aos="fade-up">
            ...
            <!-- Video SOP -->
            <video controls class="w-full h-72 object-cover rounded-lg mb-8 shadow" poster="{{ asset('img/ikonrasaumbi.png') }}">
                <source src="{{ asset('video/sop-gula-aren.mp4') }}" type="video/mp4">
