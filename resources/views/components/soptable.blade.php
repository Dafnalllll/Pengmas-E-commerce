...
<div class="bg-gray-100 p-4 lg:p-6 rounded-lg shadow-lg relative top-10 lg:top-14">
    ...
    <div class="lg:hidden space-y-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md border">
            <div class="flex justify-between items-start mb-3">
                <h3 class="font-semibold text-black text-lg">{{ $sop->title }}</h3>
            ...
            <div class="space-y-2 mb-4">
                <div class="flex justify-between">
                    ...
                    <span class="font-medium text-black">{{ $sop->date }}</span>
                </div>
            </div>

            <div class="space-y-2">
                <!-- Download Button -->
                <button onclick="downloadPDF('{{ $sop->pdf_url }}', '{{ $sop->title }}.pdf')" class="w-full bg-purple-500 hover:bg-purple-600 text-white py-2 px-3 rounded-lg font-medium transition-all duration-300 text-sm">
                    Download PDF
                </button>

                <!-- Action Buttons -->
                <div class="flex space-x-2">
                    <button onclick="alert('Edit SOP: {{ $sop->title }}')" class="flex-1 bg-gray-300 hover:bg-gray-400 text-black py-2 px-3 rounded-lg font-medium transition-all duration-300 text-sm">
                        Edit
                    </button>
    ...
    <div class="flex justify-end mt-6">
        <a href="{{ route('admin.add.sop') }}" class="bg-black hover:bg-gray-400 hover:scale-105 text-white px-4 lg:px-6 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center text-sm lg:text-base">
