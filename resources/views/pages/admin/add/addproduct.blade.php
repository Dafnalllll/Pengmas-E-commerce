...
<body class="bg-gray-100 flex flex-col lg:flex-row">
    ...
    <div class="flex-1 p-4 pt-20 lg:p-8 lg:pt-8">
        <!-- Header -->
        <h1 class="text-2xl lg:text-4xl font-bold text-gray-500 mb-6 lg:mb-8">Add Product</h1>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div
                    ...
                    <label for="image" class="cursor-pointer text-center p-4">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-8 w-8 lg:h-10 lg:w-10 text-gray-500 mx-auto mb-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span class="text-base lg:text-lg font-medium text-gray-500">Upload Foto</span>
                    </label>
                </div>
            </div>
            ...
            <!-- Harga -->
            <div class="mb-6 lg:mb-8">
                <input type="number" name="harga" placeholder="Harga (contoh: 25000)" min="0" step="1000"
                    class="w-full px-3 py-3 lg:px-4 lg:py-4 rounded-lg border-2 border-gray-500 bg-gray-100 text-black placeholder-gray-600 focus:outline-none text-base lg:text-lg"
                    required />
            </div>
            ...
            <!-- Link Produk -->
            <div class="mb-6 lg:mb-8">
                <input type="url" name="link" placeholder="Link Produk Opsional (contoh: https://shopee.co.id/...)"
                    class="w-full px-3 py-3 lg:px-4 lg:py-4 rounded-lg border-2 border-gray-500 bg-gray-100 text-black placeholder-gray-600 focus:outline-none text-base lg:text-lg">
            </div>
